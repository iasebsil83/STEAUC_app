...
import fr.stark.steauc.kalman.Kalman
...
class SceneActivity : AppCompatActivity() {
    ...
    //kalman
    var kalmanFilter : Kalman = Kalman()
    ...
    fun updateScene(){
        ...
        binding.gyroscopeText.text = kalmanFilter.dataProcessor.Xangle.toString()
        binding.accelerometerText.text = kalmanFilter.dataProcessor.XangleSpeed.toString()
        //debug
        //msg.log("Update !")
    }
